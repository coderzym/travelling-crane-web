...
export default {
  ...
  mapEnum: new Enum()
    ...
    // show: 是否展示在库区图中
    .add("input", "进料口", 0, { show: true, typeShow: true, fill: "rgba(16, 247, 191, 0.25)", activeFill: "rgba(163, 247, 191, 1)" })
    .add("output", "出料口", 1, { show: true, typeShow: true, fill: "rgba(255, 245, 145, 0.25)", activeFill: "rgba(255, 245, 145, 1)" })
    .add("area", "物料", 2, { show: true, typeShow: true, fill: "rgba(15, 255, 255, 0.25)", activeFill: "rgba(15, 255, 255, 1)" })
    .add("wall", "墙", 4, { show: true, typeShow: true, fill: "rgba(232, 21, 255, 0.25)", activeFill: "rgba(232, 211, 255, 1)" })
    .add("maintain", "检查口", 5, { show: true, typeShow: true, fill: "rgba(255, 150, 66, 0.25)", activeFill: "rgba(255, 150, 66, 1)" })
    .add("mask", "遮罩", 6, { show: true, typeShow: false })
    .add("warehouse", "库区", 7, { show: true, typeShow: false, fill: "rgba(95,149,255,0.05)", activeFill: "rgba(95,149,255, 1)" }),
